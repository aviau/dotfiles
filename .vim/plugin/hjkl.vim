...
function! s:PrintMaze()
  ...
  call setline(len(s:maze)+3,"type q twice to quit the game")
endfunction
...
function! s:HandleKeyInput(c)
  ...
  if c=='q'
    echo "Press q again to quit, any other key to restore"
